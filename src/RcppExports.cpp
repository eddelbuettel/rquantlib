...
// doubleKOVannaVolgaEngine
Rcpp::List doubleKOVannaVolgaEngine(std::string type, double barrierUp, double barrierDown, double underlying, double strike, double dividendYield, double riskFreeRate, double maturity, double vol25Put1, double volAtm1, double vol25Call1, double volatility);
RcppExport SEXP RQuantLib_doubleKOVannaVolgaEngine(SEXP typeSEXP, SEXP barrierUpSEXP, SEXP barrierDownSEXP, SEXP underlyingSEXP, SEXP strikeSEXP, SEXP dividendYieldSEXP, SEXP riskFreeRateSEXP, SEXP maturitySEXP, SEXP vol25Put1SEXP, SEXP volAtm1SEXP, SEXP vol25Call1SEXP, SEXP volatilitySEXP) {
BEGIN_RCPP
    SEXP __sexp_result;
    {
        Rcpp::RNGScope __rngScope;
        ...
        Rcpp::traits::input_parameter< double >::type volatility(volatilitySEXP );
        Rcpp::List __result = doubleKOVannaVolgaEngine(type, barrierUp, barrierDown, underlying, strike, dividendYield, riskFreeRate, maturity, vol25Put1, volAtm1, vol25Call1, volatility);
        PROTECT(__sexp_result = Rcpp::wrap(__result));
    }
    UNPROTECT(1);
    return __sexp_result;
...
RcppExport SEXP RQuantLib_oneTouchEngine(SEXP typeSEXP, SEXP underlyingSEXP, SEXP strikeSEXP, SEXP cashPayoffSEXP, SEXP dividendYieldSEXP, SEXP riskFreeRateSEXP, SEXP maturitySEXP, SEXP volatilitySEXP, SEXP strikesSEXP, SEXP expirationsRcppSEXP, SEXP volMatrixRcppSEXP) {
BEGIN_RCPP
    SEXP __sexp_result;
    {
        Rcpp::RNGScope __rngScope;
        ...
        Rcpp::List __result = oneTouchEngine(type, underlying, strike, cashPayoff, dividendYield, riskFreeRate, maturity, volatility, strikes, expirationsRcpp, volMatrixRcpp);
        PROTECT(__sexp_result = Rcpp::wrap(__result));
    }
    UNPROTECT(1);
    return __sexp_result;
