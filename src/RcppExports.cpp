...
static SEXP RQuantLib_setDayCount_try(SEXP strSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::traits::input_parameter< std::string >::type str(strSEXP);
    __result = Rcpp::wrap(setDayCount(str));
    return __result;
END_RCPP_RETURN_ERROR
}
RcppExport SEXP RQuantLib_setDayCount(SEXP strSEXP) {
    SEXP __result;
    {
        Rcpp::RNGScope __rngScope;
        __result = PROTECT(RQuantLib_setDayCount_try(strSEXP));
    }
    Rboolean __isInterrupt = Rf_inherits(__result, "interrupted-error");
    if (__isInterrupt) {
        UNPROTECT(1);
...
static int RQuantLib_RcppExport_validate(const char* sig) { 
    ...
    if (signatures.empty()) {
        ...
        signatures.insert("bool(*setDayCount)(std::string)");
...
RcppExport SEXP RQuantLib_RcppExport_registerCCallable() { 
    ...
    R_RegisterCCallable("RQuantLib", "RQuantLib_setDayCount", (DL_FUNC)RQuantLib_setDayCount_try);
