...
affineWithRebuiltCurveEngine <- function(rparam, dateVec, zeroVec, swaptionMat, swapLengths, swaptionVols) {
    .Call('RQuantLib_affineWithRebuiltCurveEngine', PACKAGE = 'RQuantLib', rparam, dateVec, zeroVec, swaptionMat, swapLengths, swaptionVols)
}
