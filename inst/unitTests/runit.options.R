...
checkEquals(DKO(type="call", barrierDown=1.1, barrierUp=1.5, strike=1.22687, underlying=1.30265, dividendYield=0.0003541, riskFreeRate=0.0033871, maturity=1.0, vol25Put=0.10087, volATM=0.08925, vol25Call=0.08463, volatility=0.10088)$value, 0.07456, tol=1.0e-3) 
checkEquals(DKO(type="call", barrierDown=1.1, barrierUp=1.5, strike=1.31179, underlying=1.30265, dividendYield=0.0003541, riskFreeRate=0.0033871, maturity=1.0, vol25Put=0.10087, volATM=0.08925, vol25Call=0.08463, volatility=0.08925)$value, 0.02710, tol= 1.0e-3) 
checkEquals(DKO(type="call", barrierDown=1.1, barrierUp=1.5, strike=1.38843, underlying=1.30265, dividendYield=0.0003541, riskFreeRate=0.0033871, maturity=1.0, vol25Put=0.10087, volATM=0.08925, vol25Call=0.08463, volatility=0.08463)$value, 0.00569, tol=1.0e-3) 
checkEquals(DKO(type="call", barrierDown=1.1, barrierUp=1.5, strike=1.46047, underlying=1.30265, dividendYield=0.0003541, riskFreeRate=0.0033871, maturity=1.0, vol25Put=0.10087, volATM=0.08925, vol25Call=0.08463, volatility=0.08412)$value, 0.00013, tol=1.0e-3) 
...
checkEquals(DKO(type="put", barrierDown=1.1, barrierUp=1.5, strike=1.22687, underlying=1.30265, dividendYield=0.0003541, riskFreeRate=0.0033871, maturity=1.0, vol25Put=0.10087, volATM=0.08925, vol25Call=0.08463, volatility=0.10088)$value, 0.00354, tol=1.0e-3) 
...
checkEquals(DKO(type="call", barrierDown=1.0, barrierUp=1.6, strike=1.06145, underlying=1.30265, dividendYield=0.0009418, riskFreeRate=0.0039788, maturity=2.0, vol25Put=0.10891, volATM=0.09525, vol25Call=0.09197, volatility=0.12511)$value, 0.19981, tol=1.0e-3) 
checkEquals(DKO(type="call", barrierDown=1.0, barrierUp=1.6, strike=1.19545, underlying=1.30265, dividendYield=0.0009418, riskFreeRate=0.0039788, maturity=2.0, vol25Put=0.10891, volATM=0.09525, vol25Call=0.09197, volatility=0.10890)$value, 0.10389, tol=1.0e-3) 
checkEquals(DKO(type="call", barrierDown=1.0, barrierUp=1.6, strike=1.32238, underlying=1.30265, dividendYield=0.0009418, riskFreeRate=0.0039788, maturity=2.0, vol25Put=0.10891, volATM=0.09525, vol25Call=0.09197, volatility=0.09444)$value, 0.03555, tol=1.0e-3) 
checkEquals(DKO(type="call", barrierDown=1.0, barrierUp=1.6, strike=1.44298, underlying=1.30265, dividendYield=0.0009418, riskFreeRate=0.0039788, maturity=2.0, vol25Put=0.10891, volATM=0.09525, vol25Call=0.09197, volatility=0.09197)$value, 0.00634, tol=1.0e-3) 
checkEquals(DKO(type="call", barrierDown=1.0, barrierUp=1.6, strike=1.56345, underlying=1.30265, dividendYield=0.0009418, riskFreeRate=0.0039788, maturity=2.0, vol25Put=0.10891, volATM=0.09525, vol25Call=0.09197, volatility=0.09261)$value, 0.00000, tol=1.0e-3) 

checkEquals(DKO(type="put", barrierDown=1.0, barrierUp=1.6, strike=1.06145, underlying=1.30265, dividendYield=0.0009418, riskFreeRate=0.0039788, maturity=2.0, vol25Put=0.10891, volATM=0.09525, vol25Call=0.09197, volatility=0.12511)$value, 0.00000, tol=1.0e-3) 
checkEquals(DKO(type="put", barrierDown=1.0, barrierUp=1.6, strike=1.19545, underlying=1.30265, dividendYield=0.0009418, riskFreeRate=0.0039788, maturity=2.0, vol25Put=0.10891, volATM=0.09525, vol25Call=0.09197, volatility=0.10890)$value, 0.00436, tol=1.0e-3) 
checkEquals(DKO(type="put", barrierDown=1.0, barrierUp=1.6, strike=1.32238, underlying=1.30265, dividendYield=0.0009418, riskFreeRate=0.0039788, maturity=2.0, vol25Put=0.10891, volATM=0.09525, vol25Call=0.09197, volatility=0.09444)$value, 0.03173, tol=1.0e-3) 
checkEquals(DKO(type="put", barrierDown=1.0, barrierUp=1.6, strike=1.44298, underlying=1.30265, dividendYield=0.0009418, riskFreeRate=0.0039788, maturity=2.0, vol25Put=0.10891, volATM=0.09525, vol25Call=0.09197, volatility=0.09197)$value, 0.09346, tol=1.0e-3) 
checkEquals(DKO(type="put", barrierDown=1.0, barrierUp=1.6, strike=1.56345, underlying=1.30265, dividendYield=0.0009418, riskFreeRate=0.0039788, maturity=2.0, vol25Put=0.10891, volATM=0.09525, vol25Call=0.09197, volatility=0.09261)$value, 0.17704, tol=1.0e-3) 


 
} 

test.AmericanBinary<-function(){
